...
export interface Transaction {
  ...
  type: TransactionType; shares: number; price: number; fee: number; note: string
}
...
export interface Holding {
  id: string; stock: string; market: Market; name: string
...
export interface DailySnapshot {
  id: string; date: string; cash: number
  stockValue: number; twStockValue: number; usStockValue: number
  totalAsset: number; dailyPnl: number; note: string
}

export interface PortfolioSummary {
  totalAsset: number; cash: number; stockValue: number
  twStockValue: number; usStockValue: number
...
export interface AssetDistribution {
  cash: number
  stocks: { stock: string; name: string; value: number; market: Market }[]
}
...
export interface PriceCache {
  [symbol: string]: { data: PriceData; cachedAt: number }
}
...
export interface ApiResponse<T> {
  data: T; error?: string; timestamp: string
}
